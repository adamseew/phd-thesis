...
We have further investigated the validity of the algorithm on other energy-critical mobile robots, by, for instance, applying the approach to the space robotics context~\citep{seewald2020beyond}.


\section{Problem Formulation}
\label{sec:pb-form}

To formulate the mobile robot planning problem we adopt to the following mathematical notation. 
