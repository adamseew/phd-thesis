...
The battery is modlede as a perfect voltage source connected with a resistor (the internal resistance of the battery)... %todo
%gonzalez longatt circuit based battery models: a review
