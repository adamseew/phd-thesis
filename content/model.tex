...
where $y(t)\in\mathbb{R}$ is the power at time instant $t$. We discuss matrices $A,C,$ and $B$ in \frefeq{eq:mat_A}, \frefeq{eq:mat_C}, and \frefeq{eq:mat_B}, and the nominal control $\mathbf{u}$ in \fref{sec:nom-cont}{Section}.
