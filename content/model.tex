...
After having illustrated the energy model, we enhance it with the energy contribution of the path in and of the computations in \fref{sec:merging}{Subsection}. 
...
\begin{figure}[h]
  ...
  \caption[Path of a aerial robot flying a given stage]{.}
  \label{fig:tee1}
\end{figure}
\begin{figure}[h]
  \centering
