...
The OCP can be stated similarly as in \fref{sec:opt-constrained}{Subsection}, with the constraints: the control constraint in \fref{def:const-set}{Definition}, the output constraint in \fref{def:const}{Definition}, and the dynamics with the ideal state evolution in \frefeq{eq:state-perf}
