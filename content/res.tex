...
\begin{figure}[t!]
  ...
  \begin{subfigure}[b]{0.32\textwidth}
    ...
    \label{fig:pednet}
  \end{subfigure}
  \caption[Computations energy models in terms of SoC, schedules over time]{Computations energy models in term of SoC as well as the schedule over time for the second case study.}
