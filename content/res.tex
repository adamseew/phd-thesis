...
\subsection*{The \texttt{matrix-gpu} computation}\findex{computations!matrix-gpu@\texttt{matrix-gpu}}
...
\subsection*{The \texttt{darknet-cpu}, \texttt{matrix-cpu}, \texttt{nvidia-matrix}, and \texttt{nvidia-quicks} computations}\findex{computations!darknet-cpu@\texttt{darknet-cpu}}\findex{computations!matrix-cpu@\texttt{matrix-cpu}}\findex{computations!nvidia-matrix@\texttt{nvidia-matrix}}\findex{computations!nvidia-quicks@\texttt{nvidia-quicks}}
...
%From our experiments, we additionally observe the power-related effect
