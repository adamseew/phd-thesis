...
\section{\color{red}Planning for Autonomous UAVs}

\subsection{\color{red}Flight controllers}

\subsection{\color{red}Energy models in aerial robotics}

\subsection{\color{red}State estimation in aerial robotics}

\subsection{\color{red}Optimal control in aerial robotics}
