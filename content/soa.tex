...
%Because of the unpredictable nature of these architectures, our
%models are built using statistical analysis based on physical energy-consumption
%measurements and hardware characteristics observed during program execution,
%including Performance Monitoring Units (PMUs).
%from teamplay deliv. D4.3
